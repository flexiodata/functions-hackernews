# ---
# name: hackernews-search-comments
# deployed: true
# title: Hacker News Search Comments
# description: Returns the 100-most-relevant Hacker News comments matching the search term
# params:
#   - name: properties
#     type: array
